...
/**
 * Marks a Gradle service that can be looked up from the build (Gradle) scope via
 * {@link org.gradle.api.invocation.Gradle#service(Class)}, including from init scripts and Gradle plugins.
 *
